      ...
      <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-300 max-w-2xl mx-auto">
                Hit revenue targets and earn one-time bonus payouts on top of
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
              {COMMISSION_ACCELERATORS.milestones.map((m) => (
                <div
                  key={m.id}
                  className="bg-white/10 backdrop-blur rounded-xl p-5 text-center hover:bg-white/15 transition"
                >
                  <div className="text-4xl mb-2">{m.badge}</div>
                  <div className="font-bold text-lg">{m.label}</div>
                  <div className="text-3xl font-extrabold text-yellow-400 my-2">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-slate-600 max-w-3xl mx-auto">
                Every add-on, service, and upsell earns you commissions. The
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-slate-200">
                    <span className="text-sm font-medium text-slate-700">
                      Premium Add-Ons ({PREMIUM_ADDONS.length} available)
                    </span>
                    <span className="font-bold text-emerald-700">
                      Same as your tier %
                    </span>
                ...
                {COMMISSION_ACCELERATORS.earningsExamples.map((ex) => (
                  ...
                  >
                    ...
                    <div className="text-2xl font-extrabold text-emerald-700">
                      ${ex.monthlyEarnings.toLocaleString()}/mo
                    </div>
                    <div className="text-xs text-slate-400 mb-2">
                      ${ex.annualEarnings.toLocaleString()}/yr
                    </div>
                    <div className="text-xs text-slate-500">
                      {ex.description}
                    </div>
        ...
        <footer className="bg-slate-50 border-t border-slate-200 py-12 px-6 text-center">
          ...
          <p className="text-slate-500 mb-8">
            Join our growing network of partner agencies and start earning up to
