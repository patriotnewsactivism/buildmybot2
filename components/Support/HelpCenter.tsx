...
const HELP_CATEGORIES = [
  {
    ...
    description:
      'Learn the basics of BuildMyBot and create your first AI agent in minutes.',
    articles: [
      {
        id: 'create-bot',
        title: 'Creating and Configuring Chatbots',
        duration: '5 min',
      },
      {
        id: 'embed-widget',
        title: 'Embedding the Chat Widget on Your Site',
        duration: '3 min',
      },
      {
        id: 'persona-setup',
        title: 'Choosing the Right AI Persona',
        duration: '4 min',
      },
    ],
  },
  {
    ...
    articles: [
      ...
      {
        id: 'web-scraping',
        title: 'Using the Web Scraper for Training',
        duration: '4 min',
      },
      {
        id: 'knowledge-refresh',
        title: 'Keeping Your Knowledge Base Up to Date',
        duration: '3 min',
      },
    ],
  },
  {
    ...
    articles: [
      {
        id: 'voice-config',
        title: 'Configuring Your Voice Agent',
        duration: '7 min',
      },
      {
        id: 'phone-numbers',
        title: 'Provisioning Local Phone Numbers',
        duration: '3 min',
      },
      {
        id: 'call-routing',
  ...
  },
  {
    ...
    articles: [
      ...
      {
        id: 'metered-billing',
        title: 'How Voice Minute Metering Works',
        duration: '4 min',
      },
      {
        id: 'white-label-billing',
        title: 'Partner & White-Label Fees',
        duration: '3 min',
      },
    ],
  },
      ...
      case 'create-bot':
        return (
          <div className="prose prose-slate max-w-none">
            ...
            <p className="lead">
              Follow this guide to build a high-converting AI chatbot for your
              business.
            </p>

            <h3>Step 1: Choose Your Template</h3>
            <p>
              From the "My Bots" dashboard, click <strong>"New Bot"</strong>.
              You can start from a blank canvas or choose an industry-specific
              template like Real Estate, E-commerce, or Customer Support.
            </p>

            <h3>Step 2: Configure the System Prompt</h3>
            <p>
              The system prompt is the "brain" of your bot. It defines how the
              AI should behave. For example:
            </p>
            <div className="bg-slate-100 p-4 rounded-lg font-mono text-sm border-l-4 border-blue-600 mb-4">
              "You are a professional receptionist for a Dental Clinic. Your
              goal is to answer patient questions about services and book
              appointments via Calendly."
            </div>

            <h3>Step 3: Training Your Bot</h3>
            <p>
              Go to the <strong>Knowledge</strong> tab. Here you can upload
              PDFs, text files, or paste URLs. BuildMyBot will scrape the
              content and use it as the source of truth for the AI's answers.
            </p>

            <h3>Step 4: Test & Deploy</h3>
            <p>
              Use the built-in simulator to chat with your bot. Once satisfied,
              click <strong>"Embed Code"</strong> to copy the snippet to your
              website header.
            </p>
          </div>
        );
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16">
        {selectedArticle ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {HELP_CATEGORIES.map((cat) => (
              <div
                key={cat.id}
                className="bg-white rounded-3xl border border-slate-200 p-8 hover:shadow-xl transition-all group"
              >
        ...
        <div className="mt-20 bg-gradient-to-br from-blue-900 to-indigo-900 rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden">
          ...
          <p className="text-blue-200 mb-8 relative z-10">
            Our support team is available 24/7 to help you with technical or
            billing issues.
          </p>
          <div className="flex flex-wrap justify-center gap-4 relative z-10">
            <a
              href="/contact"
              className="bg-white text-blue-900 px-8 py-3 rounded-xl font-bold hover:bg-blue-50 transition-all flex items-center gap-2"
            >
