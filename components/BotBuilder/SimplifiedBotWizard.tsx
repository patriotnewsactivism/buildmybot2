    ...
    <div className="flex h-screen bg-gray-50 text-slate-800 font-sans overflow-hidden">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {step === 2 && (
                <div className="space-y-6">
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">System Prompt (The Brain)</label>
                    <p className="text-xs text-gray-500 mb-2">These are the core instructions your bot will never forget.</p>
                    <textarea 
                ...
                <div className="space-y-6">
                  <div className="bg-blue-50 p-4 rounded-lg border border-blue-100 mb-4">
                    ...
                    <p className="text-sm text-blue-600 mt-1">
                        Upload documents or add website links. The bot will use this data to answer questions.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <button className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-gray-300 rounded-xl hover:border-blue-500 hover:bg-blue-50 transition-all group">
                        ...
                        <span className="font-medium text-gray-600 group-hover:text-blue-600">Upload PDF/Doc</span>
                    </button>
                    <button className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-gray-300 rounded-xl hover:border-blue-500 hover:bg-blue-50 transition-all group">
                        <Globe className="text-gray-400 group-hover:text-blue-500 mb-2" size={32} />
                        <span className="font-medium text-gray-600 group-hover:text-blue-600">Add Website URL</span>
                    </button>
                  </div>
                  
                  {/* Placeholder for list of added files */}
                  <div className="mt-4">
                     <p className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Active Sources</p>
              ...
              {step === 4 && (
                 <div className="space-y-6">
                    <div className="bg-green-50 p-6 rounded-xl border border-green-100 text-center">
                        ...
                        <h2 className="text-xl font-bold text-green-900">Ready to Deploy</h2>
                        <p className="text-green-700 mt-2">
                            Review your settings on the right. If everything looks good, click Create Bot below.
                        </p>
                    </div>
                    ...
                    <div className="bg-white border rounded-lg p-4 space-y-3">
                        ...
                        <div className="flex justify-between py-2 border-b">
                            ...
                            <span className="font-medium uppercase">{formData.model}</span>
                        </div>
          ...
          {step < 4 ? (
            ...
            >
              {isSaving ? (
                 ...
                 <><span>Saved!</span><CheckCircle size={20}/></>
              ) : (
                 <><span>Create Bot</span><Save size={20}/></>
              )}
            </button>
          )}
        </div>
      ...
      <div className="hidden lg:flex w-1/2 bg-slate-100 items-center justify-center p-12">
        <div className="w-full max-w-md bg-white rounded-[2.5rem] shadow-2xl overflow-hidden border-8 border-slate-900 h-[800px] flex flex-col relative">
            {/* Phone Notch */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-40 h-7 bg-slate-900 rounded-b-2xl z-20"></div>
            ...
            <div className="flex-1 bg-gray-50 p-4 space-y-4 overflow-y-auto">
                ...
                <div className="flex justify-start">
                    <div className="bg-white border border-gray-100 p-3 rounded-2xl rounded-tl-none shadow-sm max-w-[80%] text-sm text-gray-600">
                        {formData.role ? `As a ${formData.role}, I can assist you with...` : 'I can help you with that...'}
                    </div>
                </div>
            </div>
